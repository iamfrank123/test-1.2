        ...
        <div className="min-h-screen bg-stone-50">
            ...
            <main className="container mx-auto px-4 py-8 max-w-6xl">
                <div className="text-center mb-8">
                    <h1 className="text-4xl font-bold text-amber-700">🎵 Solfeggio Melodico</h1>
                    <p className="text-amber-600 mb-4">Suona le note corrette, nell'ottava giusta e a tempo.</p>
